...
namespace LibraryManagement.DataAccess.Repository
{
    public class BookRepository : GenericRepository<Book>, IBookRepository
    {
        ...
        public async Task<IReadOnlyList<Book>> GetBooksByAvailibityAsync(bool availibility)
        {
            ...
            return await _dbSet.Where(b => b.IsAvailable == availibility).ToListAsync();
        ...
        public async Task<IReadOnlyList<Book>> GetBooksByCategoryAsync(string category)
        {
            ...
            return await _dbSet.Where(b => b.Category.ToLower().Contains(category.ToLower())).ToListAsync();
        }
